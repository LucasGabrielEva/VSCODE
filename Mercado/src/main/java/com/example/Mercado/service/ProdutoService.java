...
public class ProdutoService {
    ...
    public List<ProdutoResponseDTO> listaTodos() {
        return produtoRepository
                .findAll()
                .stream()
                .map(p -> new ProdutoResponseDTO(p.getNome(), p.getPreco(), p.getQuantidade(), p.getDescricao(), p.getImagem()))
                .toList();
    ...
    public  ProdutoModel salvaProduto(ProdutoRequestDTO dto) {
        ...
        novoProduto.setImagem(dto.getImagem());
    ...
    public ProdutoModel atualizarProduto(Long id, ProdutoRequestDTO dto) {
        ...
        atualizarProduto.setImagem(dto.getImagem());
